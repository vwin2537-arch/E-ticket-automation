...
// 1 = ยิงเน็ต DNP เบาที่สุด + กิน RAM น้อย (แก้ 19/7/69: เน็ตด่านวูบ → 3 แท็บ warm พร้อมกัน
// = ยิง DNS/TCP รัวเกินไป เน็ตอ่อนรับไม่ไหว timeout สลับวินาที. ลดเหลือ 1 ให้เน้นเสถียรก่อนเร็ว)
const POOL_SIZE = 1;
